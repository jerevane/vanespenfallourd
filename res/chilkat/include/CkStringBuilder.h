...
class CK_VISIBLE_PUBLIC CkStringBuilder  : public CkMultiByteBase
{
	...
	// Replaces the first occurrence of the content found between beginMark and endMark. The
	// beginMark and endMark are included in what is replaced if replacement is true.
