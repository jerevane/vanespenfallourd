...
\includegraphics[width=1.25\textwidth]{instance.jpeg}
\end{sidewaysfigure}
...
\includegraphics[width=1.25\textwidth]{Ecran_acceuil_ff.png}
\end{sidewaysfigure}

\begin{sidewaysfigure}[ht]
\caption{Ecran d'acceuil avec l'elementaire de feu}
\includegraphics[width=1.25\textwidth]{Ecran_acceuil_fire_elemental.png}
\end{sidewaysfigure}
